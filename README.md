...
>
> - **Admin TUI + owner seed** (`mcp-appointments-crm admin tui`, PRD §3.8.8 / RF9 / ADR-0010, scope in ADR-0016) — designed, not implemented. Account setup today is manual SQL (demo-plan Paso 5).
