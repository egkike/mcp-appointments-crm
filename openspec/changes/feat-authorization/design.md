...
| **R3** — `accounts.professional_id` sin FK explícita a `professionals` | Baja | Decisión 6: replicar verbatim PRD. El invariant se enforce en uso (middleware Fase 2 puede validar `professionals.status`). Reversible con migration ligera. |
