...
- (c) **El Chat pregunta el caller_id al iniciar** (sin config): fricción cada vez que abre el Chat. **Rechazado** (la config se hace una vez en el TUI menú).
...
- `docs/PRD.md` §5.1 RF9 (install.sh y seed del owner vía TUI menú)
